...
const ORDERED_LIST = [
    ...
    { name: 'Spike (EQG)', img: 'eqg/Spike', filly: true, eqg: true, gender: 'male', community: false },
    ...
    // Background
    { name: 'Ace Point', img: 'background/Ace_Point', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Apple Bumpkin', img: 'background/Apple_Bumpkin', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Apple Cider', img: 'background/Apple_Cider', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Apple Cinnamon', img: 'background/Apple_Cinnamon', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Apple Cobbler', img: 'background/Apple_Cobbler', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Apple Dumpling', img: 'background/Apple_Dumpling', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Apple Fritter', img: 'background/Apple_Fritter', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Apple Honey', img: 'background/Apple_Honey', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Apple Leaves', img: 'background/Apple_Leaves', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Apple Munchies', img: 'background/Apple_Munchies', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Apple Pie', img: 'background/Apple_Pie', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Apple Split', img: 'background/Apple_Split', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Barber Groomsby', img: 'background/Barber_Groomsby', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Beauty Brass', img: 'background/Beauty_Brass', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Bill Neigh', img: 'background/Bill_Neigh', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Bittersweet', img: 'background/Bittersweet', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Bubblegum Blossom', img: 'background/Bubblegum_Blossom', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Bushel', img: 'background/Bushel', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Candy Apples', img: 'background/Candy_Apples', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Candy Mane', img: 'background/Candy_Mane', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Caramel', img: 'background/Caramel', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Caramel Apple', img: 'background/Caramel_Apple', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Cherry Fizzy', img: 'background/Cherry_Fizzy', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Cherry Gold', img: 'background/Cherry_Gold', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Coco Crusoe', img: 'background/Coco_Crusoe', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Count Caesar', img: 'background/Count_Caesar', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Crimson Gala', img: 'background/Crimson_Gala', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Curly Cobbler', img: 'background/Curly_Cobbler', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Dainty Dove', img: 'background/Dainty_Dove', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Dance Fever', img: 'background/Dance_Fever', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Eclair Creme', img: 'background/Eclair_Creme', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Eiffel', img: 'background/Eiffel', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Emerald Green', img: 'background/Emerald_Green', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Felix', img: 'background/Felix', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Fiddly Twang', img: 'background/Fiddly_Twang', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Florina Tart', img: 'background/Florina_Tart', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Gala Appleby', img: 'background/Gala_Appleby', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Globe Trotter', img: 'background/Globe_Trotter', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Golden Delicious', img: 'background/Golden_Delicious', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Goldengrape', img: 'background/Goldengrape', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Green Jewel', img: 'background/Green_Jewel', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Half Baked Apple', img: 'background/Half_Baked_Apple', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Hughbert Jellius', img: 'background/Hughbert_Jellius', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Jeff Letrotski', img: 'background/Jeff_Letrotski', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Jonagold', img: 'background/Jonagold', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Lady Gaval', img: 'background/Lady_Gaval', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Lavender Bloom', img: 'background/Lavender_Bloom', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Lavender Fritter', img: 'background/Lavender_Fritter', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Lilac Links', img: 'background/Lilac_Links', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Luckette', img: 'background/Luckette', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Lucky Clover', img: 'background/Lucky_Clover', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Meadow Song', img: 'background/Meadow_Song', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Minty', img: 'background/Minty', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Mjölna', img: 'background/Mjolna', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Mr. Breezy', img: 'background/Mr._Breezy', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Noteworthy', img: 'background/Noteworthy', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Parcel Post', img: 'background/Parcel_Post', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Parish Nandermane', img: 'background/Parish_Nandermane', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Peachy Sweet', img: 'background/Peachy_Sweet', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Perfect Pace', img: 'background/Perfect_Pace', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Purple Wave', img: 'background/Purple_Wave', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Pursey Pink', img: 'background/Pursey_Pink', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Raven Inkwell', img: 'background/Raven_Inkwell', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Red Delicious', img: 'background/Red_Delicious', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Rivet', img: 'background/Rivet', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Royal Riff', img: 'background/Royal_Riff', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Ruby Splash', img: 'background/Ruby_Splash', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Savoir Fare', img: 'background/Savoir_Fare', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Screwball', img: 'background/Screwball', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Screwy', img: 'background/Screwy', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Sealed Scroll', img: 'background/Sealed_Scroll', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Serena', img: 'background/Serena', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Shooting Star', img: 'background/Shooting_Star', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Silver Berry', img: 'background/Silver_Berry', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Sir Pony Moore', img: 'background/Sir_Pony_Moore', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Spring Forward', img: 'background/Spring_Forward', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Star Gazer', img: 'background/Star_Gazer', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Strawberry Ice', img: 'background/Strawberry_Ice', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Tall Order', img: 'background/Tall_Order', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Twilight Sky', img: 'background/Twilight_Sky', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Vidala Swoon', img: 'background/Vidala_Swoon', filly: false, eqg: false, gender: 'female', community: false },
    { name: 'Walter', img: 'background/Walter', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Wensley', img: 'background/Wensley', filly: false, eqg: false, gender: 'male', community: false },
    { name: 'Wisp', img: 'background/Wisp', filly: false, eqg: false, gender: 'male', community: false },
    ...
    { name: 'Crackle', img: 'unsorted/Crackle', filly: false, eqg: false, gender: 'female', community: false },
    ...
    { name: 'Dragon Lord Torch', img: 'unsorted/Dragon_Lord_Torch', filly: false, eqg: false, gender: 'male', community: false },
    ...
    { name: 'Grubber', img: 'unsorted/Grubber', filly: false, eqg: false, gender: 'male', community: false },
    ...
    { name: 'Phyllis', img: 'unsorted/Phyllis', filly: false, eqg: false, gender: 'female', community: false },
    ...
    { name: 'Spike', img: 'unsorted/Spike', filly: true, eqg: false, gender: 'male', community: false },
